...
% comment this out if out of memory
...
for imageNum = 1:numImages
  for featureNum = 1:numFeatures
    ...
    for channel = 1:imageChannels
      ...
      feature = reshape(WZ(featureNum,offset+1:offset+patchSize), patchDim, patchDim);
    ...
    convolvedImage = sigmoid(convolvedImage + bw(featureNum));
